...
import { Menu, ChevronDown, ChevronUp, CircleUser, LogOut } from "lucide-react";
      ...
      <div className="relative" ref={dropdownRef}>
        ...
        {open && (
          <div className="absolute right-2 mt-5 w-60 text-sm text-gray-500 bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden z-50">
            ...
            {/* ✅ No Settings link for staff */}

            <div className="border-t border-gray-200" />

            {/* Logout */}
            <button
              onClick={staffLogout} // ✅ calls staffLogout directly, not a Link
