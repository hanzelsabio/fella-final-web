...
const ContactDetails = () => {
  ...
  return (
    <div className="pb-6">
      ...
      <div className="border border-gray-200 bg-white rounded-lg p-4 sm:p-6 mb-4">
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="flex items-center gap-2 text-xs bg-black hover:bg-gray-800 text-white rounded-md px-4 py-3 transition-colors"
          >
      ...
      {/* ── Location & Map ────────────────────────────────────────── */}
      <div className="border border-gray-200 bg-white rounded-lg p-4 sm:p-6">
        <h3 className="text-sm font-semibold text-gray-800 mb-4">
          Location & Map
        </h3>
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mt-1">
              ...
              <code className="bg-gray-100 px-1 rounded">src="..."</code> value.
            </p>
          </div>
