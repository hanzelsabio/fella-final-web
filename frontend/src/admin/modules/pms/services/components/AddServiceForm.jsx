...
const AddServiceForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Save list items as JSON array to the body column
        ...
        <div className="border border-gray-200 rounded-lg bg-white py-4 sm:py-6 mb-4">
          <div className="flex justify-between items-start border-b border-gray-200 gap-5 mb-5">
            <div className="flex-1 pb-5 px-4 sm:px-6">
              ...
              <p className="text-xs text-gray-600">
                Create a new service for your products
              </p>
            </div>
          ...
          <div className="space-y-4 px-4 sm:px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {/* Short description — shown as bold subtitle in modal */}
              ...
              {/* List details — one item per line → stored as JSON array → renders as numbered list */}
              <div className="col-span-full">
                <label className="block text-xs font-medium text-gray-700 mb-2">
                  Service Details{" "}
